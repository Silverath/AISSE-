...
public class DropboxAuth {
	...
	// -------------------------------------------------------------------------------------------
	// Start the process of getting a Dropbox API access token for the user's
	// Dropbox account.
	...
	public void doStart(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		// application.
		// The Dropbox website will send them back to /dropbox-auth-finish when
		// they're done.
	...
	// -------------------------------------------------------------------------------------------
	// The Dropbox API authorization page will redirect the user's browser to
	// this page.
	//
	// This is a GET (even though it modifies state) because we get here via a
	// browser
