...
/**
 * Placeholders for protection against CSRF and UI Redress. The protection isn't
 * actually implemented -- see TODOs below.
 */
public class FormProtection {
	...
	public void insertAntiCsrfFormField(PrintWriter out) {
		...
		// SECURITY TODO: Generate a real token. This dummy token is obviously
		// insecure.
		String token = "dummy";
	...
	public static String checkAntiCsrfToken(HttpServletRequest request) throws IOException, ServletException {
		if (request.getContentType() != null
				...
				&& request.getPart("anti-csrf-token") == null || request.getParameter("anti-csrf-token") == null) {
